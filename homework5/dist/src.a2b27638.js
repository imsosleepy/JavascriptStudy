...
var rightNum = '';
var leftNum = '';
var operatorChecker = false;
var equalChecker = false;
var operator = '';
...
function calculate() {
  var result = eval(leftNum + operator + rightNum);
  resultInput.value = leftNum = result;
}

function handleClick(event) {
  var target = event.target;
  var innerValue = target.innerText;
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "11202" + '/');
